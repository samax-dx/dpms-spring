...
public interface UserLoginRepository extends Repository<ZViewEntity, Long> {
    String USER_LOGIN_QUERY = "select New com.akcl.dpms.svc_main.dto.UserLogin(u.userId, u.name, u.email, l.loginId) from User u join Login l on u.userId = l.user.userId";
